...
#' @param geo a vector or factor of geographic units grouping the samples of the matrix
...
#' @return a named vector of the number of species/OTUs of each sample uniquely found in
